...
unit_a_plus_b <= offset = Port_int.new( 'iOffset', 0, 10 ) # global offset valid from 0..10
...
unit_a_plus_b >= UnitOutput.new(Port_int.new( 'iLastA' ), Proc.new {| a | a.value }, a) 

# Makes new Unittest
unit_test = UnitTest_c.new( unit_a_plus_b, Scg_module.new("./APlusB/a_plus_b.c") )
#Do it
unit_test.make
